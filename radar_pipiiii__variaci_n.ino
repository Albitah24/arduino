...
void procesarDatos() {
  ...
  else if (distanciaReal >= 700 && distanciaReal < 850) {
    intervalo = 1000;
  } 
  else if (distanciaReal >= 400 && distanciaReal < 550) {
    intervalo = 750;
  }
  else if (distanciaReal >= 275 && distanciaReal < 400) {
    intervalo = 500;
  } 
  else if (distanciaReal >= 150 && distanciaReal < 275) {
    intervalo = 750;
  }
  else if (distanciaReal >= 150 && distanciaReal < 275) {
    intervalo = 250;
  } 
  else if (distanciaReal >= 100 && distanciaReal < 150) {
    intervalo = 100;
  } 
